...
eta_ee_soft=1/1000; % Learning rate of EE
...
% distributions.
save('/scratch/AlanAkil/singlerun_softHebbian_ee_distributions.mat', 'JRec_ee',...
    'mC','mV','mR','IeRec','IiRec','IxRec','Tburn','Tburn_raster',...
    'N','T','dt','c','dtRate','Jm','Jxm','seed','T1','T2','tauSTDP',...
    'winsize','W','Wx','rx','eRateT','iRateT','Jmax_ee_soft',...
    'eta_ee_soft','Cee_distribution','Cei_distribution',...
