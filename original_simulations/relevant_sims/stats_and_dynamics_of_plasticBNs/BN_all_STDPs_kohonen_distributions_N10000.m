...
%     JRec_ii(:,ii)=(J(sub2ind(size(J),Jrecord_ii(1,:),Jrecord_ii(2,:))));
    ...
    if mod(i*dt,T/10) == 0 % print every ten iterations.
        fprintf('At time %d...\n',i*dt/T);
    end
end
...
% distributions.
save('/scratch/AlanAkil/singlerun_kohonen_ee_distributions_N10000.mat', 'JRec_ee',...
    'mC','mV','mR','IeRec','IiRec','IxRec','Tburn','Tburn_raster',...
    'N','T','dt','c','dtRate','Jm','Jxm','seed','T1','T2','tauSTDP',...
    'winsize','W','Wx','rx','eRateT','iRateT','beta',...
    'eta_ee_kohonen','Cee_distribution','Cei_distribution',...
