...
%%% Classical Hebbian (soft constraints), Kohonen's rule, and homeostatic 
...
%%% See Appendix of Akil et al 2021 for more details
tic
...
eta_ee_hard=1/100; % Learning rate of EE
...
%% Check E, I, X currents to check for balance.
figure; hold on
plot(mean(IeRec))
plot(mean(IiRec))
plot(mean(IxRec))
