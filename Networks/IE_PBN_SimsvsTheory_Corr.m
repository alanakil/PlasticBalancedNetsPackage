...
%             clear st;
        ...
        Record_Jmean(k,rz) = mean( nonzeros( J(1:0.8*N,0.8*N+1:N) ) );
        Record_Jstd(k,rz) = std( nonzeros( J(1:0.8*N,0.8*N+1:N) ) );
...
save('/scratch/AlanAkil/BurnVariablesCorr.mat', 'meanFinalCee','meanFinalCei','meanFinalCii',...
