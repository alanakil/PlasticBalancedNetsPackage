...
%%% parameters this way
% Plasticity params
eta1 = 0; % Learning rate for EE.
eta2 = 0; % Learning rate for EI.
tauSTDP=50;
...
Jei = linspace(-150,-100,Num_J_vals);

Jm=[25 Jei(1); 112.5 -250]/sqrt(N);
Jxm=[180; 135]/sqrt(N);
...
for j = 1:Num_J_vals
    ...
    W(1,2) = Jei(j)*qi*P(1,2); % 0.2 is fraction of inh neurons.
...
save('./J_vs_Cab_Nonplastic.mat', 'eRateT','iRateT','T','dtRate',...
    'timeRecord','N','Theory_Cee','Theory_Cei','Theory_Cii',...
    'c','spikeTimes','spikeIndex','Vector_Time_Rate','Jei',...
    'Num_J_vals','r_e','r_i','Theory_Ree','Theory_Rei',...
    'Theory_Rii','mC','mR','W','Wx','rx','eta1','eta2');
