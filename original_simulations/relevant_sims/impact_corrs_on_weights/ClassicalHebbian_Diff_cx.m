...
save('/scratch/AlanAkil/ClassicalHebbian_Diff_cx.mat', 'meanFinalCee','meanFinalCei','meanFinalCii',...
    ...
    'reSim','riSim','IeRecord','Jmax','Jee_time',...
    'IiRecord','IxRecord','r_e_theory','r_i_theory');
