...
%%%%% Plasticity params %%%%%%
tauSTDP=50; % Timescale of eligibility trace
...
% distributions.
save('/scratch/AlanAkil/singlerun_eiSTDP_distributions_lowtaustdp.mat', 'JRec_ei',...
    'mC','mV','mR','IeRec','IiRec','IxRec','Tburn','Tburn_raster',...
    'N','T','dt','c','dtRate','Jm','Jxm','seed','T1','T2','tauSTDP',...
    'winsize','W','Wx','rx','eRateT','iRateT',...
    'eta_ei','Cee_distribution','Cei_distribution',...
    ...
    'spikeTimes_I','spikeIndex_I','Jmax_ei');
